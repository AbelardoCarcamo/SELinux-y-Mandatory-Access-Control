...
- [ Paso 1 — Instalación de dependencias](#️-paso-1--instalación-de-dependencias)
- [ Paso 2 — Iniciar servicios](#-paso-2--iniciar-servicios)
- [ Paso 3 — Verificar estado de SELinux](#-paso-3--verificar-estado-de-selinux)
- [ Paso 4 — Verificar contextos de seguridad](#️-paso-4--verificar-contextos-de-seguridad)
...
- [ Paso 8 — Contraste: Permissive vs Enforcing](#️-paso-8--contraste-permissive-vs-enforcing)
...
- [ Resumen de herramientas](#️-resumen-de-herramientas)
